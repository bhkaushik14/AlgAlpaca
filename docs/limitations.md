...
- The frozen 100-case fixture is project-specific and distinct from the second-stage dataset's 1,637-example held-out test split. Three conditions on one fixture support no external-benchmark, population, inferential-statistical, general mathematical ability, or production claim. Exhaustive semantic non-overlap with every generated training example has not been established.
